  ...
  <body background="./img/img1.jpeg">
      ...
      //Facilitamos recogida de datos con variables sencillas
        ...
        if (mysqli_num_rows($result) > 0) {
          echo "<table border='1'><tr><td BGCOLOR='#5da89e' colspan='4'><center><h3>Variables</h3></center></td></tr><tr><th>AÑO</th><th>Número de ventas</th><th>Número de clientes potenciales</th><th>Número de ventas totales</th></tr>";
        ...
        $result = mysqli_query($conexion, $sql); 
        if (mysqli_num_rows($result) > 0) {
          echo "<table border='1'><tr><td BGCOLOR='#5da89e' colspan='8'><center><h3>Datos activos</h3></center></td></tr><tr><th>AÑO</th><th>Beneficio bruto</th><th>Impuestos</th><th>Intereses</th><th>Despreciacion</th><th>Gastos Generales</th><th>Inversiones</th><th>Total activos</th></tr>";
            while($row = mysqli_fetch_assoc($result)) {
        ...
        $result = mysqli_query($conexion, $sql); 
        if (mysqli_num_rows($result) > 0) {
          echo "<table border='1'><tr><td BGCOLOR='#5da89e' colspan='3'><center><h3>Datos pasivos</h3></center></td></tr><tr><th>AÑO</th><th>Capital</th><th>Fondos propios</th></tr>";
            while($row = mysqli_fetch_assoc($result)) {
        ...
        $result = mysqli_query($conexion, $sql); 
        if (mysqli_num_rows($result) > 0) {
          echo "<table border='1'><tr><td BGCOLOR='#5da89e' colspan='5'><center><h3>Datos Marketing</h3></center></td></tr><tr><th>AÑO</th><th>Clics</th><th>Impresiones</th><th>Capacidad actual</th><th>Capacidad máxima</th></tr>";
            while($row = mysqli_fetch_assoc($result)) {
        ...
        $result = mysqli_query($conexion, $sql); 
        if (mysqli_num_rows($result) > 0) {
          echo "<table border='1'><tr><td BGCOLOR='#5da89e' colspan='3'><center><h3>Pérdidas y ganancias</h3></center></td></tr><tr><th>AÑO</th><th>Amortizaciones</th><th>Provisiones</th></tr>";
            while($row = mysqli_fetch_assoc($result)) {
