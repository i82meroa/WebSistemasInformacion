  ...
  <body style="background-color:powderblue;">
      ...
      //Facilitamos recogida de datos con variables sencillas
        ...
        if (mysqli_num_rows($result) > 0) {
          echo "<table border='1'><tr><td colspan='4'><center><h3>Variables</h3></center></td></tr><tr><th>AÑO</th><th>Número de ventas</th><th>Número de clientes potenciales</th><th>Número de ventas totales</th></tr>";
        ...
        $result = mysqli_query($conexion, $sql); 
        if (mysqli_num_rows($result) > 0) {
          echo "<table border='1'><tr><td BGCOLOR='#00FF00' colspan='8'><center><h3>Datos activos</h3></center></td></tr><tr><th>AÑO</th><th>Beneficio bruto</th><th>Impuestos</th><th>Intereses</th><th>Despreciacion</th><th>Gastos Generales</th><th>Inversiones</th><th>Total activos</th></tr>";
            while($row = mysqli_fetch_assoc($result)) {
